import lexers.PascalLexer;
import org.antlr.v4.runtime.CharStreams;
import org.antlr.v4.runtime.CodePointCharStream;
import org.antlr.v4.runtime.CommonTokenStream;
import parsers.PascalParser;
import visitors.PascalBaseVisitor;

public class Boot {

    public static void main(String[] args)
    {
        final String input = "program Example;\n" +
                "var\n" +
                "  z, y, x : LongInt;\n" +
                "begin\n" +
                "  x := 12445;\n" +
        ...
        final PascalParser.ProgramContext program = pascalParser.program();
